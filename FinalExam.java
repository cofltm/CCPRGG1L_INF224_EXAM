    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (colums != 8 ||rows == 0 || rows == 1 || rows == 9 || 
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (rows == 1 && (colums != 1) || rows == 2 && (colums != 2) || 
                rows == 3 && (colums != 3 ) || rows == 4 && (colums != 4) ||
                rows == 5 && (colums != 5) || rows == 6 && (colums != 6) ||
                rows == 7 && (colums != 7) || rows == 8 && (colums != 8) ||
                rows == 9 && (colums != 9) || rows == 0 || rows == 10 || 
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (rows != 13 || colums == 0 || colums == 1 ||
                colums == 9 || colums == 10 || colums == 11 ||
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (colums != 1 ||rows == 0 || rows == 1 || rows == 2 || 
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (rows == 10 && (colums != 7) || rows == 9 && (colums != 8) || 
                rows == 8 && (colums != 9 ) || rows == 7 && (colums != 10) ||
                rows == 6 && (colums != 11) || rows == 5 && (colums != 12) ||
                rows == 4 && (colums != 13) || rows == 3 && (colums != 14) ||
                rows == 0 || rows == 1 || rows == 2 || rows == 11 || 
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (rows == 10 && (colums != 5) || rows == 9 && (colums != 4) || 
                rows == 8 && (colums != 3 ) || rows == 7 && (colums != 2) ||
                rows == 6 && (colums != 1) || rows == 5 && (colums != 0) ||
                rows == 0 || rows == 1 || rows == 2 || rows == 3 || 
                rows == 4 || rows == 11 || rows == 12 || rows == 13 ||
                rows == 14){
                    System.out.print(" ");
                }
                else{
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (rows != 12 || colums == 0 || colums == 1 ||
                colums == 2|| colums == 3 || colums == 4 || 
                colums == 5 || colums == 6){
                    System.out.print(" ");
                }
                else{
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (rows == 0 && (colums != 9) || rows == 1 && (colums != 8) || 
                rows == 2 && (colums != 7) || rows == 3 && (colums != 6) ||
                rows == 4 && (colums != 5) || rows == 5 && (colums != 4) ||
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (rows == 6 && (colums != 0) || rows == 7 && (colums != 1) || 
                rows == 8 && (colums != 2) || rows == 9 && (colums != 3) ||
                rows == 10 && (colums != 4) ||
                rows == 0 || rows == 1 || rows == 2 || rows == 3 || 
                rows == 4 || rows == 5 || rows == 11 || rows == 12 ||
                rows == 13 || rows == 14){
                    System.out.print(" ");
                }
                else{
        ...
        for (int rows = 0; rows < 15; rows++){
            ...
            for (int colums = 0; colums < 15; colums++){
                ...
                if (colums != 14 ||rows == 0 || rows == 1 || rows == 2 || 
                rows == 3 || rows == 13 || rows == 14){
                    System.out.print(" ");
                }
                else{
                    System.out.print(array[rows][colums]);
